      ...
      <div className="max-w-[1100px] mx-auto px-6 py-12 grid lg:grid-cols-[1fr_280px] gap-14 items-start">
        <article>
          <nav className="flex items-center gap-2 font-mono text-xs text-muted-light mb-6">
            ...
            <span>/</span>
            <span className="text-white/70">SPF Record Guide</span>
          </nav>
          ...
          <div className="flex items-center gap-5 flex-wrap mb-8 pb-6 border-b border-white/10">
            ...
            <span className="font-mono text-muted-light text-[11.5px]">📋 Technical Guide</span>
          </div>
          ...
          <div className="article-content text-[#c8d5e8]" style={{ lineHeight: 1.8 }}>
            ...
            <div className="bg-brand/[0.07] border border-brand/20 rounded-xl p-5 my-7">
              ...
              <span className="text-[#a5cdb5]">
                <strong className="text-white">Quick check:</strong> Run a test at{" "}
                <Link href="/" className="text-brand underline">CheckEmailDelivery.com</Link> to
                see if your SPF is working correctly.
              </span>
            </div>

            <h2 id="what-is-spf" className="font-display text-white text-2xl mt-12 mb-4 pt-3 border-t border-white/10">
            ...
            <pre className="bg-black/30 border border-white/10 rounded-lg px-5 py-4 font-mono text-sm text-brand overflow-x-auto mb-6">
              v=spf1 include:_spf.google.com ~all
            </pre>

            <p className="mb-5">This record says:</p>
            <ul className="list-disc ml-6 space-y-1 mb-6">
              <li><code className="bg-white/10 px-1 rounded">v=spf1</code> — This is an SPF version 1 record</li>
              <li><code className="bg-white/10 px-1 rounded">include:_spf.google.com</code> — Google Workspace servers are authorized</li>
              <li><code className="bg-white/10 px-1 rounded">~all</code> — Softfail anything not listed (mark as suspicious)</li>
            </ul>

            <h2 id="syntax" className="font-display text-white text-2xl mt-12 mb-4 pt-3 border-t border-white/10">
              ...
              <table className="w-full text-sm border-collapse">
                <thead>
                  <tr className="bg-white/5">
                    <th className="text-left px-4 py-3 text-muted-light font-mono text-[11px] uppercase tracking-wider border-b border-white/10">Mechanism</th>
                    <th className="text-left px-4 py-3 text-muted-light font-mono text-[11px] uppercase tracking-wider border-b border-white/10">Example</th>
                    <th className="text-left px-4 py-3 text-muted-light font-mono text-[11px] uppercase tracking-wider border-b border-white/10">Meaning</th>
                  </tr>
                </thead>
                <tbody>
                  <tr className="border-b border-white/5">
                    <td className="px-4 py-3 font-mono text-brand">include:</td>
                    <td className="px-4 py-3"><code className="text-white/80">include:_spf.google.com</code></td>
                    <td className="px-4 py-3 text-muted-light">Include another domain&apos;s SPF</td>
                  </tr>
                  <tr className="border-b border-white/5">
                    <td className="px-4 py-3 font-mono text-brand">ip4:</td>
                    <td className="px-4 py-3"><code className="text-white/80">ip4:192.0.2.0/24</code></td>
                    <td className="px-4 py-3 text-muted-light">Authorize an IPv4 address/range</td>
                  </tr>
                  <tr className="border-b border-white/5">
                    <td className="px-4 py-3 font-mono text-brand">ip6:</td>
                    <td className="px-4 py-3"><code className="text-white/80">ip6:2001:db8::/32</code></td>
                    <td className="px-4 py-3 text-muted-light">Authorize an IPv6 address/range</td>
                  </tr>
                  <tr className="border-b border-white/5">
                    <td className="px-4 py-3 font-mono text-brand">a</td>
                    <td className="px-4 py-3"><code className="text-white/80">a:mail.example.com</code></td>
                    <td className="px-4 py-3 text-muted-light">Authorize the A record&apos;s IP</td>
                  </tr>
                  <tr className="border-b border-white/5">
                    <td className="px-4 py-3 font-mono text-brand">mx</td>
                    <td className="px-4 py-3"><code className="text-white/80">mx</code></td>
                    <td className="px-4 py-3 text-muted-light">Authorize all MX servers</td>
                  </tr>
                </tbody>
              </table>
            </div>

            <h3 className="text-white text-lg font-medium mt-8 mb-3">Qualifiers (the ending)</h3>

            <div className="grid md:grid-cols-2 gap-4 mb-6">
              <div className="bg-brand/[0.07] border border-brand/20 rounded-lg p-4">
                <code className="text-brand font-mono text-lg">-all</code>
                <span className="text-white font-medium ml-2">Hard Fail</span>
                <p className="text-muted-light text-sm mt-1">Reject emails from unlisted servers. Strictest.</p>
              </div>
              <div className="bg-warn/[0.07] border border-warn/20 rounded-lg p-4">
                <code className="text-warn font-mono text-lg">~all</code>
                <span className="text-white font-medium ml-2">Soft Fail</span>
                <p className="text-muted-light text-sm mt-1">Mark as suspicious but accept. Most common.</p>
              </div>
              <div className="bg-[#60a5fa]/[0.07] border border-[#60a5fa]/20 rounded-lg p-4">
                <code className="text-[#60a5fa] font-mono text-lg">?all</code>
                <span className="text-white font-medium ml-2">Neutral</span>
                <p className="text-muted-light text-sm mt-1">No policy. Not recommended.</p>
              </div>
              <div className="bg-white/[0.03] border border-white/10 rounded-lg p-4">
                <code className="text-muted-light font-mono text-lg">+all</code>
                <span className="text-white font-medium ml-2">Pass All</span>
                <p className="text-muted-light text-sm mt-1">Allow anyone. Never use this!</p>
              </div>
            </div>

            <h2 id="common-includes" className="font-display text-white text-2xl mt-12 mb-4 pt-3 border-t border-white/10">
            ...
            <div className="overflow-x-auto mb-6">
              <table className="w-full text-sm border-collapse">
                <thead>
                  <tr className="bg-white/5">
                    <th className="text-left px-4 py-3 text-muted-light font-mono text-[11px] uppercase border-b border-white/10">Provider</th>
                    <th className="text-left px-4 py-3 text-muted-light font-mono text-[11px] uppercase border-b border-white/10">SPF Include</th>
                  </tr>
                </thead>
                <tbody>
                  {[
            ...
            <h2 id="mistakes" className="font-display text-white text-2xl mt-12 mb-4 pt-3 border-t border-white/10">
              Common SPF Mistakes
            </h2>

            <div className="space-y-4 mb-6">
              <div className="bg-danger/[0.07] border border-danger/20 rounded-lg p-4">
                <strong className="text-white block mb-1">❌ Too many DNS lookups (10 limit)</strong>
                <p className="text-muted-light text-sm">
                  SPF allows only 10 DNS lookups total. Each <code className="bg-white/10 px-1 rounded">include:</code>,{" "}
                  <code className="bg-white/10 px-1 rounded">a</code>, <code className="bg-white/10 px-1 rounded">mx</code>,{" "}
                  and <code className="bg-white/10 px-1 rounded">redirect</code> counts. If you hit this limit, SPF fails entirely.
                </p>
              ...
              <div className="bg-danger/[0.07] border border-danger/20 rounded-lg p-4">
                <strong className="text-white block mb-1">❌ Multiple SPF records</strong>
                <p className="text-muted-light text-sm">
              ...
              <div className="bg-warn/[0.07] border border-warn/20 rounded-lg p-4">
                <strong className="text-white block mb-1">⚠️ Using +all</strong>
                <p className="text-muted-light text-sm">
                  This allows anyone to send email as your domain. Never use <code className="bg-white/10 px-1 rounded">+all</code>.
                </p>
              </div>

              <div className="bg-warn/[0.07] border border-warn/20 rounded-lg p-4">
                <strong className="text-white block mb-1">⚠️ Forgetting third-party services</strong>
                <p className="text-muted-light text-sm">
            ...
            <div className="space-y-4 mb-6">
              <div>
                <span className="font-mono text-[10px] text-muted-light uppercase block mb-1">Google Workspace Only</span>
                <pre className="bg-black/30 border border-white/10 rounded-lg px-5 py-4 font-mono text-sm text-brand overflow-x-auto">
                  v=spf1 include:_spf.google.com ~all
                </pre>
              </div>
              <div>
                <span className="font-mono text-[10px] text-muted-light uppercase block mb-1">Microsoft 365 + SendGrid</span>
                <pre className="bg-black/30 border border-white/10 rounded-lg px-5 py-4 font-mono text-sm text-brand overflow-x-auto">
                  v=spf1 include:spf.protection.outlook.com include:sendgrid.net ~all
                </pre>
              </div>
              <div>
                <span className="font-mono text-[10px] text-muted-light uppercase block mb-1">Multiple Services</span>
                <pre className="bg-black/30 border border-white/10 rounded-lg px-5 py-4 font-mono text-sm text-brand overflow-x-auto">
            ...
            <div className="bg-brand/[0.07] border border-brand/20 rounded-xl p-5 my-7">
              <span className="text-xl mr-2">🎯</span>
              <span className="text-[#a5cdb5]">
                <strong className="text-white">Test your SPF:</strong> Run a free email test at{" "}
                <Link href="/" className="text-brand underline">CheckEmailDelivery.com</Link> to
        ...
        <aside className="lg:sticky lg:top-24">
          ...
          >
            <h3 className="font-display text-white text-xl mb-2">Check Your SPF</h3>
